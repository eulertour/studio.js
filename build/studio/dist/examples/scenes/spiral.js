import { Geometry, Animation, } from "@eulertour/studio";
...
export default class Scene {
    constructor(scene, camera, renderer) {
        ...
        const f = (t) => {
            ...
            return new THREE.Vector3(y * Math.cos(revolutions * 2 * Math.PI * t), THREE.MathUtils.lerp(-r, r, t), y * Math.sin(revolutions * 2 * Math.PI * t));
        };
