...
export default class MeshLineGeometry extends THREE.BufferGeometry {
	...
	setVertexData(array: WritableArrayLike<number>, offset: number, x: number, y: number, z: number) {
		array[offset] = x;
		array[offset + 1] = y;
		array[offset + 2] = z;
		array[offset + 3] = x;
	...
	// *-----------------*
	// 1                 2, 4
	setIndices(array: WritableArrayLike<number>, offset: number, startIndex: number) {
