...
export declare namespace Geometry {
    ...
    const CameraDimensions: THREE_2.Vector2;
    const setCameraDimensions: (camera: THREE_2.OrthographicCamera) => void;
    const CanvasViewport: THREE_2.Vector4;
    const setCanvasViewport: (viewport: THREE_2.Vector4) => void;
...
export declare namespace Scene {
    ...
    export type Class<T> = new (scene: THREE_2.Scene, camera: THREE_2.Camera, renderer: THREE_2.WebGLRenderer) => T;
...
export declare const setCameraDimensions: (camera: THREE_2.OrthographicCamera) => void;

export declare const setCanvasViewport: (viewport: THREE_2.Vector4) => void;
