import { Animation, // A union of animation formats that can be added to this.animations
Geometry, // An interface that all scenes must implement
...
export default class Example {
    constructor(scene, camera, renderer) {
        ...
        const squareLabel = new Text.Text('\\substack{\\text{This shape is animated} \\\\ \\text{using this.animations}}');
        ...
        const circleLabel = new Text.Text('\\substack{\\text{This shape is animated} \\\\ \\text{using this.loop}}');
