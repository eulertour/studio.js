...
declare const vstack: (group: THREE.Group, buffer?: number) => THREE.Group;
declare const vspace: (group: THREE.Group, distanceBetween?: number) => THREE.Group;
...
declare const moveNextTo: (target: THREE.Object3D, object: THREE.Object3D, direction: THREE.Vector3, buffer?: number) => THREE.Object3D<THREE.Event>;
declare const moveToRightOf: (target: any, object: any, distance?: number) => THREE.Object3D<THREE.Event>;
declare const moveToLeftOf: (target: any, object: any, distance?: number) => THREE.Object3D<THREE.Event>;
declare const moveAbove: (target: any, object: any, distance?: number) => THREE.Object3D<THREE.Event>;
declare const moveBelow: (target: any, object: any, distance?: number) => THREE.Object3D<THREE.Event>;
